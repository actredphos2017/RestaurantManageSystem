...
data class MenuInfo(
    ...
    fun deleteCategory(index: Int) = categories.removeAt(index)
        ...
        val example = MenuInfo(true).apply {
            ...
            createCategory("菜品")?.apply {
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/西红柿炒鸡蛋"
                ).apply {
                    addDiyOption(
                        name = "加料",
                        singleChoice = false
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/红烧肉"
                ).apply {
                    addDiyOption(
                        name = "加辣",
                        singleChoice = true
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/宫保鸡丁"
                ).apply {
                    addDiyOption(
                        name = "辣度",
                        singleChoice = true
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/清蒸鲈鱼"
                ).apply {
                    addDiyOption(
                        name = "配菜",
                        singleChoice = false
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/青椒炒肉丝"
                ).apply {
                    addDiyOption(
                        name = "加料",
                        singleChoice = false
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/糖醋里脊"
                ).apply {
                    addDiyOption(
                        name = "加菜",
                        singleChoice = false
            ...
            createCategory("主食")?.apply {
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/经典意面"
                ).apply {
                    addDiyOption(
                        name = "面条类型",
                        singleChoice = true
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/白米饭"
                ).apply {
                    addDiyOption(
                        name = "米种",
                        singleChoice = true
            ...
            createCategory("甜点")?.apply {
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/提拉米苏"
                ).apply {
                    addDiyOption(
                        name = "大小",
                        singleChoice = true
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/杏仁豆腐"
                ).apply {
                    addDiyOption(
                        name = "口味",
                        singleChoice = true
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/芝麻糊"
                ).apply {
                    addDiyOption(
                        name = "甜度",
                        singleChoice = true
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/水果沙拉"
                ).apply {
                    addDiyOption(
                        name = "选择水果",
                        singleChoice = false
            ...
            createCategory("汤羹")?.apply {
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/玉米羹"
                ).apply {
                    addDiyOption(
                        name = "加料",
                        singleChoice = false
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/南瓜汤羹"
                ).apply {
                    addDiyOption(
                        name = "加料",
                        singleChoice = false
            ...
            createCategory("饮品")?.apply {
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/奶茶"
                ).apply {
                    addDiyOption(
                        name = "茶底",
                        singleChoice = true
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/可乐"
                ).apply {
                    addDiyOption(
                        name = "包装",
                        singleChoice = true
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/雪碧"
                ).apply {
                    addDiyOption(
                        name = "包装",
                        singleChoice = true
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/芬达"
                ).apply {
                    addDiyOption(
                        name = "包装",
                        singleChoice = true
                ...
                addDish(
                    ...
                    picUrl = "/resource/EXAMPLE/Dishes/王老吉"
                )
            }
